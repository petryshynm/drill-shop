...
export const ProdItem = ({ setOpen }) => {
      ...
      <>
        <div>
          ...
          <div className="product-profile__info">
            ...
            <div className="product-profile__title">Дриль {name}</div>
            <div className="product-profile__available">
              {quantityInStock ? "Є в наявності" : "Немає в наявності"}
            </div>
            <div className="product-profile__price">
              {newPrice ? (
                <>
                  <div className="product-profile__price-new">
                    {newPrice + "₴"}
                  </div>
                  <div className="product-profile__price-old">
                    {price + "₴"}
                  </div>
                </>
              ) : (
            ...
            <button
              ...
              className={`button ${
                isUser ? " button__main" : " button__secondary"
              }`}
            >
        ...
        <div className="product-profile__chars">
          ...
          <div className="product-profile__block">
            ...
            <ul>
              ...
              <li>
                Розмір дрилі:<span>{size}</span>
              </li>
              <li>
                Сезон надходження:<span>{season}</span>
              </li>
            </ul>
          </div>
        </div>
  ...
  return (
    <>
      {loading ? <Loader /> : null}
      <div className="product-profile">{renderedProduct}</div>
    </>
  );
};
